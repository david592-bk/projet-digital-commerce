            ...
            <div className="space-y-5 rounded-[1.75rem] bg-slate-100 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.5rem] bg-white p-5">
                  ...
                  <p className="mt-2 text-2xl font-semibold text-slate-900">{carouselItems[activeSlide].item_type === 'service' ? 'Service' : 'Produit'}</p>
                </div>
                <div className="rounded-[1.5rem] bg-white p-5">
                  <p className="text-sm text-slate-500">Catégorie</p>
                  <p className="mt-2 text-2xl font-semibold text-slate-900">{carouselItems[activeSlide].category || 'Autre'}</p>
                </div>
              </div>
                  ...
                  <div className="grid gap-4 p-5 sm:grid-cols-[120px_1fr]">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <span className="rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-700">{product.item_type === 'service' ? 'Service' : 'Produit'}</span>
                        <span className="rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-700">{product.category || 'Autre'}</span>
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">{selectedProduct.item_type === 'service' ? 'Service' : 'Produit'} • {selectedProduct.category || 'Autre'}</p>
                </div>
              </div>
